...
BEGIN
    ...
    VALUES (N'20250921162804_Initial', N'9.0.8');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250923023051_EditableAudience', N'9.0.8');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250926001349_Deleted', N'9.0.8');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250926003425_FullFeatureCampaign', N'9.0.8');
END;
